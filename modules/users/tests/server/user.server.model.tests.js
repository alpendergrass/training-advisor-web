...
describe('User Model Unit Tests:', function () {
  ...
  describe('Method Save', function () {
    ...
    it('should be able to update a user with optional fields without problems', function (done) {
      var _user1 = new User(user1);
    ...
    it('should be able to show an error when trying to update an existing user with an invalid role', function (done) {
      var _user1 = new User(user1);
