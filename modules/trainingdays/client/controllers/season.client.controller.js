...
angular.module('trainingDays')
  .controller('SeasonController', ['$scope', '$state', '$stateParams', '$compile', '$filter', '$uibModal', '$anchorScroll', 'Authentication', 'TrainingDays', 'Season', 'Feedback', 'Util', '_', 'moment', 'toastr', 'usSpinnerService', 'blockUI',
    function($scope, $state, $stateParams, $compile, $filter, $uibModal, $anchorScroll, Authentication, TrainingDays, Season, Feedback, Util, _, moment, toastr, usSpinnerService, blockUI) {
