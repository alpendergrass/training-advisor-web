...
angular.module('trainingDays')
  .controller('StartController', ['$scope', '$state', '$stateParams', '$compile', '$anchorScroll', 'Authentication', 'TrainingDays', '_', 'moment', 'toastr',
    function($scope, $state, $stateParams, $compile, $anchorScroll, Authentication, TrainingDays, _, moment, toastr) {
