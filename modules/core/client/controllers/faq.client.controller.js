  ...
  function() {
    this.FAQ = [{
      ...
      questions: [{
        ...
        answer: 'You create an account by linking to your Strava account. Click the Strava button on the sign in page, enter your Strava credentials if you are not already logged into Strava, authorize Tacit Training to access your Strava data and you are logged in.</p><p>You then need to enter some personal information on the My Profile Page. The most important bits are your time zone and your Functional Threshold Power and test date. We also recommend that you select "Fetch Strava activities automatically" to save you from having to download after every ride.</p>'
      }, {
