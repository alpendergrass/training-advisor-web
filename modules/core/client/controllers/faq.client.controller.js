  ...
  function() {
    this.FAQ = [{
      ...
      questions: [{
        ...
        answer: '<p>By all means, do the test. Use your preferred testing protocol. If you do not have one, a common method  is to do two 8 minute TTs, take the one with the higher average power and multiply by .9. Another is to do a 20 minute time trial and then multiply your average power for the TT by .95. Google can help with the details.</p><p>Once you have your new Functional Threshold Power, enter the value and the test date on the My Profile page. If for some reason you cannot test, you can estimate your FTP by looking at a recent hard ride. And if you believe your FTP has not changed, you can simply update the test date.</p><p>But it is always best to test. All the advice depends on a valid FTP value. Garbage in and all that.</p>'
      }]
    }, {
