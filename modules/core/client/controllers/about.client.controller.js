...
angular.module('core').controller('AboutController', ['$scope', 'Authentication',
  function (Authentication) {
    ...
    this.sections = [{
      title: 'What It Does',
      content: '<p>Tacit Training is a training tool for cyclists that does three main things. Using the goals you set and ride data from Strava, it will:<ol><li>Create a dynamic <b>season training plan,</b></li><li>Enable you to run <b>"what-if" scenarios</b> to see how your training may be affected if you change your goals, and</li><li>Provide <b>daily training advice</b> based on your current fitness and fatigue levels.</li></ol>While this may sound like other apps you\'ve used or heard of, what sets Tacit Training apart is the <b>always current, hands-off</b> nature of the app.</p>'
    }, {
