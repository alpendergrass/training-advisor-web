...
angular.module('core').controller('AboutController', ['$scope', 'Authentication',
  function (Authentication) {
    ...
    this.sections = [{
      ...
      title: 'Next Steps',
      content: '<p>When I first conceived of Tacit Training, I was thinking of riders like me. I love to ride, I want to ride faster and go further, I want my time on the bike to be effective training, but I am often too busy to spend a lot of time planning and monitoring my training. If this sounds like you, Tacit Training can be a game-changer. I invite you to give it a try. To get started you need to: <ul><li>Sign up.</li><li>Set your start day.</li><li>Create a goal.</li><li>Click a button to generate your season.</li></ul></p><p><b>Allez!</b></p><p><b>Al Pendergrass</b><br>Creator of Tacit Training</p><p><a class="strava-me"  href="https://www.strava.com/athletes/433782" target="_blank" title="Me on Strava"><img id="strava" src="/modules/core/client/img/strava.png" alt="Me on Strava" width="80" height="80"></a></p>'
    }];
  }
]);
