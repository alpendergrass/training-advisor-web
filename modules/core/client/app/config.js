...
var ApplicationConfiguration = (function () {
  ...
  var applicationModuleVendorDependencies = ['ngResource', 'ngAnimate', 'ngMessages', 'ngSanitize', 'ui.router', 'ui.bootstrap', 'ui.utils', 'xeditable', 'toastr', 'angularSpinner', 'angular-timezone-selector', 'ngMaterial', 'materialCalendar', 'chart.js'];
