...
var rules = [
  {
    'name': 'hardEnduranceRule',
    //'priority': -9,
    'condition': function(R) {
      R.when(this && !this.plannedActivity.workout &&
    ...
    'consequence': function(R) {
      this.plannedActivity.advice += ` You should do a long endurance ride today. You appear to be sufficiently rested.
